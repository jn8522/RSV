...
#saving
write.csv(aic, "~/rsv-modelling/Output/Data/Backwards_selection/Round 2/backwards_s_e.csv")
capture.output(fit, file="~/rsv-modelling/Output/Data/Backwards_selection/Round 2/backwards_s_e.txt")
