...
#saving
write.csv(aic, "~/rsv-modelling/Output/Data/Backwards_selection/backwards_d.csv")
capture.output(fit, file="~/rsv-modelling/Output/Data/Backwards_selection/backwards_d.txt")
