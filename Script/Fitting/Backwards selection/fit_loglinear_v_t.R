...
fit <- hjkb(initial,
            ...
            lower=c(0,0,-Inf,-Inf,-Inf,0,0,0,0,0,0),
...
capture.output(fit,
               file="~/rsv-modelling/Output/Data/Fits/Backwards selection/Fit_loglinear_v_t_output.txt")
write.csv(aic,
          file="~/rsv-modelling/Output/Data/Fits/Backwards selection/Fit_loglinear_v_t_aic.csv")
write.csv(fit$par,
          file="~/rsv-modelling/Output/Data/Fits/Backwards selection/Fit_loglinear_v_t_par.csv")
...
mse <- ssq.parameters.loglinear(fit$par,
                   ...
                   weather=weather,
                   include=include)
write.csv(mse, file="~/rsv-modelling/Output/Data/Fits/Backwards selection/Fit_loglinear_v_t_mse.csv")