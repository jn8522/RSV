...
capture.output(fit,
               file="~/rsv-modelling/Output/Data/Fits/Backwards selection/Fit_loglinear_s_output.txt")
write.csv(aic,
          file="~/rsv-modelling/Output/Data/Fits/Backwards selection/Fit_loglinear_s_aic.csv")
write.csv(fit$par,
          file="~/rsv-modelling/Output/Data/Fits/Backwards selection/Fit_loglinear_s_par.csv")
...
mse <- ssq.parameters.loglinear(fit$par,
                   ...
                   weather=weather,
                   include=include)
write.csv(mse, file="~/rsv-modelling/Output/Data/Fits/Backwards selection/Fit_loglinear_s_mse.csv")