...
#saving
write.csv(aic, "~/rsv-modelling/Output/Data/Backwards_selection/backwards_s.csv")
capture.output(fit, file="~/rsv-modelling/Output/Data/Backwards_selection/backwards_s.txt")
