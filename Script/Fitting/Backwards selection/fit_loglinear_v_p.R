...
capture.output(fit,
               file="~/rsv-modelling/Output/Data/Fits/Backwards selection/Fit_loglinear_v_p_output.txt")
write.csv(aic,
          file="~/rsv-modelling/Output/Data/Fits/Backwards selection/Fit_loglinear_v_p_aic.csv")
write.csv(fit$par,
          file="~/rsv-modelling/Output/Data/Fits/Backwards selection/Fit_loglinear_v_p_par.csv")
...
mse <- ssq.parameters.loglinear(fit$par,
                   ...
                   weather=weather,
                   include=include)
write.csv(mse, file="~/rsv-modelling/Output/Data/Fits/Backwards selection/Fit_loglinear_v_p_mse.csv")