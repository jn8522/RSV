...
#saving
write.csv(aic, "~/rsv-modelling/Output/Data/Backwards_selection/backwards_t.csv")
capture.output(fit, file="~/rsv-modelling/Output/Data/Backwards_selection/backwards_t.txt")
